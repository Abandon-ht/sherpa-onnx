// sherpa-onnx/csrc/axera/offline-tts-kokoro-axera-impl.h
//
// Copyright (c)  2025  Xiaomi Corporation
#ifndef SHERPA_ONNX_CSRC_AXERA_OFFLINE_TTS_KOKORO_AXERA_IMPL_H_
#define SHERPA_ONNX_CSRC_AXERA_OFFLINE_TTS_KOKORO_AXERA_IMPL_H_
...
class OfflineTtsKokoroAxeraImpl : public OfflineTtsImpl {
 public:
  explicit OfflineTtsKokoroAxeraImpl(const OfflineTtsConfig &config)
  ...
  OfflineTtsKokoroAxeraImpl(Manager *mgr, const OfflineTtsConfig &config)
      : config_(config),
...
#ifdef SHERPA_ONNX_ENABLE_AXERA
    if constexpr (std::is_same_v<KokoroModel, OfflineTtsKokoroModelAxera>) {
...
#endif  // SHERPA_ONNX_CSRC_AXERA_OFFLINE_TTS_KOKORO_AXERA_IMPL_H_